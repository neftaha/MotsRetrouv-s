...
public class LetterGrid extends GridBehavior implements Observer {
    ...
    public void setDataAdapter(fr.univparis8.app.motsretrouves.custom.LetterGridDataAdapter data) {
        if (data == null) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setDataAdapter(new fr.univparis8.app.motsretrouves.custom.SampleLetterGridDataAdapter(8, 8));
    }
