package fr.univparis8.app.motsretrouves.commons;
...
public enum Direction {
    ...
    public static Direction fromLine(fr.univparis8.app.motsretrouves.commons.GridIndex start, fr.univparis8.app.motsretrouves.commons.GridIndex end) {
