...
public class StreakView extends View {
    ...
    private fr.univparis8.app.motsretrouves.custom.TouchProcessor mTouchProcessor;
    ...
    protected void onDraw(Canvas canvas) {
        for (StreakLine line : mLines) {
            com.aar.app.wordsearch.commons.math.Vec2 v = com.aar.app.wordsearch.commons.math.Vec2.sub(line.end, line.start);

            float length = v.length();
            double rot = Math.toDegrees(getRotation(v, com.aar.app.wordsearch.commons.math.Vec2.Right));
            if (v.y < 0)
                rot = -rot;
    ...
    private float getRotation(com.aar.app.wordsearch.commons.math.Vec2 p1, com.aar.app.wordsearch.commons.math.Vec2 p2) {
        float dot = com.aar.app.wordsearch.commons.math.Vec2.normalize(p1).dot(com.aar.app.wordsearch.commons.math.Vec2.normalize(p2));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTouchProcessor = new fr.univparis8.app.motsretrouves.custom.TouchProcessor(new OnTouchProcessedListener(), 3.0f);
        mLines = new Stack<>();
        mRect = new RectF();
    }


    private class OnTouchProcessedListener implements fr.univparis8.app.motsretrouves.custom.TouchProcessor.OnTouchProcessed {
    ...
    public static class StreakLine {
        com.aar.app.wordsearch.commons.math.Vec2 start;
        com.aar.app.wordsearch.commons.math.Vec2 end;
        GridIndex startIdx;
        GridIndex endIdx;
        int color = Color.RED;

        public StreakLine() {
            start = new com.aar.app.wordsearch.commons.math.Vec2();
            end = new com.aar.app.wordsearch.commons.math.Vec2();
            startIdx = new GridIndex(-1, -1);
            endIdx = new GridIndex(-1, -1);
        }

        public com.aar.app.wordsearch.commons.math.Vec2 getStart() {
            return start;
        }

        public com.aar.app.wordsearch.commons.math.Vec2 getEnd() {
            return end;
        }
