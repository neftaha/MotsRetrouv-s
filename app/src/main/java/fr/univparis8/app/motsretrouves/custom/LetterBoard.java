package fr.univparis8.app.motsretrouves.custom;
...
import fr.univparis8.app.motsretrouves.commons.Direction;
import fr.univparis8.app.motsretrouves.commons.GridIndex;
...
public class LetterBoard extends CenterLayout implements Observer {
    ...
    private fr.univparis8.app.motsretrouves.custom.StreakView mStreakView;
    private fr.univparis8.app.motsretrouves.custom.LetterGrid mLetterGrid;
    private fr.univparis8.app.motsretrouves.custom.LetterGridDataAdapter mData;
    ...
    public fr.univparis8.app.motsretrouves.custom.StreakView getStreakView() {
        return mStreakView;
    }

    public fr.univparis8.app.motsretrouves.custom.LetterGrid getLetterGrid() {
        return mLetterGrid;
    }
    ...
    public fr.univparis8.app.motsretrouves.custom.LetterGridDataAdapter getDataAdapter() {
        return mData;
    }
    ...
    public void addStreakLines(List<fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine> streakLines) {
        mStreakView.addStreakLines(streakLines, false);
    }

    public void addStreakLine(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine) {
        if (streakLine != null)
    ...
    public void setDataAdapter(fr.univparis8.app.motsretrouves.custom.LetterGridDataAdapter dataAdapter) {
        if (dataAdapter == null) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mStreakView = new fr.univparis8.app.motsretrouves.custom.StreakView(context);
        mLetterGrid = new fr.univparis8.app.motsretrouves.custom.LetterGrid(context);
        ...
        setDataAdapter(new fr.univparis8.app.motsretrouves.custom.SampleLetterGridDataAdapter(gridRowCount, gridColCount));
        ...
        mStreakView.setSnapToGrid(fr.univparis8.app.motsretrouves.custom.StreakView.SnapType.fromId(snapToGrid));
    ...
    private class StreakViewInteraction implements fr.univparis8.app.motsretrouves.custom.StreakView.OnInteractionListener {
        ...
        @Override
        public void onTouchBegin(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine) {
        ...
        @Override
        public void onTouchDrag(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine) {
            if (mSelectionListener != null)
        ...
        @Override
        public void onTouchEnd(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine) {
            if (mSelectionListener != null) {
    ...
    public interface OnLetterSelectionListener {
        void onSelectionBegin(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine, String str);
        void onSelectionDrag(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine, String str);
        void onSelectionEnd(fr.univparis8.app.motsretrouves.custom.StreakView.StreakLine streakLine, String str);
    }
}
