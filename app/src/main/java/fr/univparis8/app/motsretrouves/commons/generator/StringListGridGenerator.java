package fr.univparis8.app.motsretrouves.commons.generator;
...
public class StringListGridGenerator extends fr.univparis8.app.motsretrouves.commons.generator.GridGenerator<List<String>, List<String>> {
